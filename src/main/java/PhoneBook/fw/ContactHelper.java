...
public class ContactHelper extends BaseHelper {
    ...
    public void addContactPositiveData(String name, String number) {
        // Click on ADD link
        ...
        // enter email
        type(By.xpath("//input[@placeholder='email']"), "katranchik21@gmail.com");
        // enter address
        type(By.xpath("//input[@placeholder='Address']"), "Germany, Hannover");
        // enter description
    ...
    public void deleteFirstContact() {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(2)).until(ExpectedConditions.numberOfElementsToBe
